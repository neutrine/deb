...
Forked from: https://github.com/linuxmuster/deb/blob/main/createStaticDirectoryListing.py

usage: python3 create-static-directory-listing.py [-h] [--indexPage INDEXPAGE] directory
"""
